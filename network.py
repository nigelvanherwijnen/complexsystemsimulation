...
class Graph:
    ...
    def single_node_update(self, node):
...
if __name__ == '__main__':
    ...
    graph = Graph(nv, ne, a=a, eps=eps)

    for i in range(100):
        print(i)
        graph.timestep(N)

    pickle.dump( graph, open("graph_14_" + str(nv) + "_" + str(ne) + "_04.p", "wb") )
